                            ...
                            <ul class="menu-list">
                                <li class="menu-item has-children">
                                    ...
                                    <ul class="sub-menu">
                                        <li class="sub-menu-item">
                                            <a href="{{route('admin.student.create')}}" class="">
                                ...
                                <li class="menu-item has-children">
                                    ...
                                    <ul class="sub-menu">
                                        ...
                                        <li class="sub-menu-item">
                                            <a href="{{route('admin.course.index')}}" class="">
                                ...
                                <li class="menu-item has-children">
                                    ...
                                    <ul class="sub-menu">
                                        <li class="sub-menu-item">
                                            <a href="{{route('admin.teacher.create')}}" class="">
                                                <div class="text">New Teacher</div>
                                            </a>
                                        </li>
                                        <li class="sub-menu-item">
                                            <a href="{{route('admin.teacher.index')}}" class="">
                                ...
                                <li class="menu-item has-children">
                                    <a href="javascript:void(0);" class="menu-item-button">
                                        <div class="icon"><i class="icon-layers"></i></div>
                                        <div class="text">Timetables</div>
                                    </a>
                                    <ul class="sub-menu">
                                        <li class="sub-menu-item">
                                            <a href="{{route('admin.timetable.create')}}" class="">
                                                <div class="text">New Timetable</div>
                                            </a>
                                        </li>
                                        <li class="sub-menu-item">
                                ...
                                <li class="menu-item has-children">
                                    ...
                                    <ul class="sub-menu">
                                        <li class="sub-menu-item">
                                            <a href="{{route('admin.assignment.create')}}" class="">
                                                <div class="text">New Assignment</div>
                                            </a>
                                        </li>
                                        <li class="sub-menu-item">
                                            <a href="{{route('admin.assignment.index')}}" class="">
                                 ...
                                 <li class="menu-item has-children">
                                    <a href="javascript:void(0);" class="menu-item-button">
                                        <div class="icon"><i class="icon-layers"></i></div>
                                        <div class="text">Anouncements</div>
                                    </a>
                                    <ul class="sub-menu">
                                        <li class="sub-menu-item">
                                            <a href="{{route('admin.announcement.create')}}" class="">
                                                <div class="text">New Anouncement</div>
                                            </a>
                                        </li>
                                        <li class="sub-menu-item">
                                            <a href="{{route('admin.announcement.index')}}" class="">
                                                <div class="text">Anouncements</div>
                                            </a>
                                        </li>
                                    </ul>
                                ...
                                <li class="menu-item">
                                    <a href="{{route('admin.grade.index')}}" class="">
                                        <div class="icon"><i class="icon-image"></i></div>
                                        <div class="text">Grade</div>
                                    </a>
                                </li>
                                <li class="menu-item">
                                    <a href="{{route('admin.event.index')}}" class="">
                                        <div class="icon"><i class="icon-grid"></i></div>
                                ...
                                <li class="menu-item">
                                    <a href="{{route('admin.marks.index')}}" class="">
                                        <div class="icon"><i class="icon-grid"></i></div>
                                ...
                                <li class="menu-item">
                                    <a href="{{route('admin.attendance.index')}}" class="">
                                        <div class="icon"><i class="icon-user"></i></div>
                                        <div class="text">Attendence</div>
                                    </a>
                                </li>
                                <li class="menu-item">
                                    <a href="{{route('admin.feetype.index')}}" class="">
                                        <div class="icon"><i class="icon-user"></i></div>
                                        <div class="text">Fee Type</div>
                                    </a>
                                </li>
