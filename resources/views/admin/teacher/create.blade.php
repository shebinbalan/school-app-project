                            ...
                            <div class="main-content-wrap">
                                <div class="flex items-center flex-wrap justify-between gap20 mb-27">
                                    ...
                                    <ul class="breadcrumbs flex items-center flex-wrap justify-start gap10">
                                        ...
                                        <li>
                                            <div class="text-tiny">Add Teacher</div>
                                        </li>
                                    </ul>
                                </div>
                                <!-- form-add-product -->
                                <form class="tf-section-2 form-add-product" method="POST"  action="{{route('admin.teacher.store')}}">
                                    @csrf                                  
                                    <div class="wg-box">
                                        <fieldset class="name">
                                        ...
                                        <fieldset class="name">
                                            ...
                                            <input class="mb-10" type="text" placeholder="Enter Qualification"
                                                name="qualification" tabindex="0" value="{{old('qualification')}}" aria-required="true" required="">
                                        ...
                                        <div class="cols gap22">
                                            <fieldset class="name">
                                                ...
                                                <input class="mb-10" type="date" placeholder="Date Of Birth"
                                                    name="dob" tabindex="0" value="{{old('dob')}}" aria-required="true"
                                                    required="">
                                            </fieldset>
                                            @error('dob')
                                        <span class="alert alert-danger text-center">{{ $message }}</span>      
                                        ...
                                        <div class="cols gap22">
                                            <fieldset class="name">
                                                ...
                                                <input class="mb-10" type="text" placeholder="Enter subjects taught"
                                                    name="subjects_taught" tabindex="0" value="{{old('subjects_taught')}}" aria-required="true"
                                                    required="">
                                            </fieldset>
