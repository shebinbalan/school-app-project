                            ...
                            <div class="main-content-wrap">
                                <div class="flex items-center flex-wrap justify-between gap20 mb-27">
                                    ...
                                    <ul class="breadcrumbs flex items-center flex-wrap justify-start gap10">
                                        ...
                                        <li>
                                            <div class="text-tiny">New Marks</div>
                                        </li>
                                    </ul>
                                </div>
                                <!-- new-category -->
                                <div class="wg-box">
                                    <form class="form-new-product form-style-1" action="{{route('admin.marks.store')}}" method="POST">
                                        @csrf
                                        ...
                                        <fieldset class="subject">
                                            ...
                                            <input class="flex-grow" type="text" placeholder="Subject" name="subject"
                                                tabindex="0" value="{{old('subject')}}" aria-required="true" required="">
                                        </fieldset>
                                        @error('subject')
                                        <span class="alert alert-danger text-center" role="alert">{{ $message }}</span>      
                                        @enderror
                                        <fieldset class="subject">
                                            ...
                                            <input class="flex-grow" type="text" placeholder="Marks" name="marks"
                                                tabindex="0" value="{{old('marks')}}" aria-required="true" required="">
                                        </fieldset>
                                        @error('marks')
                                        <span class="alert alert-danger text-center" role="alert">{{ $message }}</span>      
                                        @enderror
